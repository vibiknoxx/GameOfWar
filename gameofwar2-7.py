...
def get_welcome_response():
    ...
    speech_output = "Welcome to the game of war testmode, your deck has been shuffled and dealt to you and the computer" 
...
def handle_ShowMyScore(intent, session):
    ...
    reprompt_text = "Are you ready to keep playing? If so say play."
    #HERE
...
def handle_ShuffleDeck(intent, session):
    ...
    speech_output = "deck has been shuffled, say play to play a card"
    reprompt_text = "Are you ready to keep playing"
 #   if self.Slots[AMAZON.YesIntent] == True:
  #      should_end_session = False
